...
# Setup the PyCaret AutoML experiment 
exp_clf = setup(data = df_training, target = 'Buyer', session_id=5614,
                categorical_features=['Age', 'MaritalStatus', 'Gender', 'YearlyIncome', 'TotalChildren', 'NumberChildrenAtHome', 'Education',  'HouseOwnerFlag'],
...
save_model(best_model, r'D:\Onyx Data\sales-model')
...
# %%
df_test.to_csv(r'D:\Onyx Data\sales-model.csv',
               index=False)
